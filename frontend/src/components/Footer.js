...
export default function Footer() {
  return (
    <footer className="bg-keen-black text-white mt-24" data-testid="footer">
      <div className="max-w-7xl mx-auto px-6 py-16">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-12">
          <div className="col-span-2 md:col-span-1">
            <h3 className="font-heading font-extrabold text-2xl tracking-tight mb-4">KEEN</h3>
        ...
        <div className="border-t border-white/10 mt-12 pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
          <p className="text-white/40 text-sm">&copy; 2025 KEEN. All rights reserved.</p>
